...
x_train, y_train, word_to_index, index_to_word = get_train_sentences(VOCABULARY_SIZE)
...
# x_train, y_train, word_to_index, index_to_word = get_train_sentences_reversed(VOCABULARY_SIZE)
